...
Durable notes for an agent working on this repo — one file per fact, read before
starting. `../CLAUDE.md` is the technical handoff; these are the working conventions
around it.
